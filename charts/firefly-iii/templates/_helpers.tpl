...
*/}}
{{- define "firefly-iii.postgresServiceName" -}}
{{- printf "%s-postgres" (include "firefly-iii.fullname" .) | trunc 63 | trimSuffix "-" -}}
{{- end }}

{{/*
Firefly application secret name.
*/}}
{{- define "firefly-iii.fireflySecretName" -}}
{{- default (include "firefly-iii.fullname" .) .Values.firefly.secrets.existingSecret -}}
{{- end }}
